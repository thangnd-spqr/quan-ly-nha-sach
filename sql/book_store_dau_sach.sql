...
CREATE TABLE `dau_sach` (
  ...
  `ten_dau_sach` varchar(45) DEFAULT NULL,
  `ten_the_loai` varchar(45) DEFAULT NULL,
...
INSERT INTO `dau_sach` VALUES (1,'Harry Potter','Huyền Ảo'),(2,'Tiếng Việt 1 ','SGK'),(3,'Nhà giả kim','Văn học');
